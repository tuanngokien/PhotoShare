...
class Follows(models.Model):
    createdat = models.DateTimeField(db_column='createdAt')  # Field name made lowercase.
    updatedat = models.DateTimeField(db_column='updatedAt')  # Field name made lowercase.
    follow_by = models.ForeignKey(Users, models.DO_NOTHING, db_column='follow_by', blank=True, null=True)
    follow_to = models.ForeignKey(Users, models.DO_NOTHING, db_column='follow_to', blank=True, null=True)
