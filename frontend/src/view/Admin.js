...
const noti = [
  "Nguyễn Văn A ảnh có nội dung xấu",
  "Trần Thị B ảnh có nội dung chống phá và kích động",
  "Lê Văn Kiên nhập sai mật khẩu quá 10 lần, tạm khóa",
  "Lê Thị D có dấu hiệu đăng nhập bất thường",
]
